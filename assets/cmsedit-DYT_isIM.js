...
* And finally, a manual Save button. We discovered in demos that, while we could PATCH valid changes as the user makes them, our users prefer the agency and finality that comes with a nice Save button click.`;export{e as default};
