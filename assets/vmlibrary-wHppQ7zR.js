...
I co-lead the Frontend Guild, focusing on architecture, initiatives, and documentation. Additionally, I joined the UX team’s weekly meeting as a liaison between frontend engineering and design/product; it was a good opportunity to dust off my design chops, and they were happy to start the partnership from that shared context.
...
* Aurelia does have a Redux implementation, which I talk about [here](#/questionnaires). What’s relevant to this is that it justifies using rxjs—if an official Aurelia package has it as a dependency, I can add that version of rxjs as a dependency of vm-library without having to argue the case.
...
* GridData was a class a developer could instantiate that would manage your GridModel. I talk a little about it [here](#/questionnaires).
