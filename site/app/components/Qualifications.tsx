...
const Qualification = observer(({ qualification }: { qualification: QualificationType }) => {
    ...
    return <div className="relative">
        <h3 className={`font-heading-1 text-2xl text-neutral-800 uppercase my-2`}>{qualification.opener}</h3>
        <p className="text-neutral-800 text-lg my-2">{qualification.copy}</p>
    </div>
})
