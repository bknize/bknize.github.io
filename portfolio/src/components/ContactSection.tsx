...
const socialLinks = [
  { icon: GitHubIcon, label: "GitHub", href: "https://github.com/bknize", hoverClass: "hover:text-white hover:border-white/30" },
  { icon: LinkedInIcon, label: "LinkedIn", href: "https://www.linkedin.com/in/benknize/", hoverClass: "hover:text-cmyk-cyan hover:border-cmyk-cyan/30" },
  { icon: MailIcon, label: "Email", href: "mailto:bknize@gmail.com", hoverClass: "hover:text-cmyk-yellow hover:border-cmyk-yellow/30" },
];
